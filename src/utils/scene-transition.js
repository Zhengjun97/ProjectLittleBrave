...
export function createSceneTransition(scene, options){
    ...
    const g = scene.add.graphics().fillRectShape(rectShape).setDepth(-1); //-1 to be shown top of everything setDepth used to draw things in different layer or order
